...
const shots: Shot[] = [
  ...
  { src: upload1.url, alt: "Detrás de cámaras en el set de Diario del Poder", caption: "Backstage" },
  { src: upload2.url, alt: "Grabación de un episodio en Madrid", caption: "Backstage" },
  { src: upload3.url, alt: "Preparativos antes de la entrevista", caption: "Backstage" },
  { src: upload4.url, alt: "Momento entre toma y toma del podcast", caption: "Backstage" },
...
export function Backstage() {
  ...
  return (
 <section id="backstage" className="py-16 md:py-32 border-t border-border overflow-hidden">
