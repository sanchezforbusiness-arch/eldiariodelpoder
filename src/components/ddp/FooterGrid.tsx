  ...
  return (
    <footer id="contact" className="relative overflow-hidden border-t border-border">
      ...
      <div aria-hidden className="select-none overflow-hidden">
        <p className="-mb-[0.22em] translate-y-[0.06em] whitespace-nowrap px-6 text-center text-[22vw] font-medium leading-[0.8] tracking-[-0.05em] text-foreground/10 md:px-12">
          DIARIO DEL PODER
        </p>
      </div>
    </footer>
