...
export function Episodes() {
  ...
  return (
    <section id="episodes" className="py-20 md:py-40 border-t border-border">
      <div className="container-ddp">
        ...
        >
          <div className="relative aspect-[4/5] sm:aspect-[16/9] md:aspect-[21/9] overflow-hidden bg-card">
            <img
              src={featured.img}
              alt={featured.guest}
              loading="lazy"
