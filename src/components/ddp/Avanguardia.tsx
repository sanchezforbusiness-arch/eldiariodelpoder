    ...
    <section id="avanguardia" className="py-28 md:py-40 relative overflow-hidden">
      ...
      <div className="container-ddp relative">
        ...
        <div className="mt-14 max-w-2xl mx-auto space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed text-center">
          <p>Cerramos acuerdo con <em className="text-foreground/90 italic">La Vanguardia</em>. Ningún podcast independiente lo había hecho.</p>
          <p>Distribución, estudio y respaldo editorial a la altura del proyecto.</p>
          <p>Para los sponsors: estar <em className="text-foreground/90 italic">desde el primer capítulo</em>.</p>
        </div>
