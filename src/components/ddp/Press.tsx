...
export function Press() {
  ...
  return (
 <section id="prensa" className="relative py-16 md:py-32 border-t border-border overflow-hidden">
      {/* Ambient glow */}
      <div
        aria-hidden
      ...
      <div className="container-ddp">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-end mb-16 md:mb-24 reveal">
          <div className="md:col-span-8">
            ...
            <h2 className="text-display md:text-display lg:text-display leading-[0.98] tracking-tight font-medium">
              Lo que cuentan
              <br />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 border-y border-border mb-20 md:mb-28 reveal">
          {stats.map((s, i) => (
            ...
            >
              <div className="font-serif text-display md:text-display font-light text-foreground leading-none">
                {s.value}
              </div>
            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-2 relative min-h-[260px] md:min-h-0 overflow-hidden bg-background">
                ...
                <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between">
                  ...
                  <ArrowUpRight size={28} className="text-foreground group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                </div>
              </div>
            </div>
          </a>
        ...
        <div className="flex items-center gap-4 mb-10 reveal">
          <span className="text-2xs tracking-label uppercase text-foreground">Aparecidos en</span>
            ...
            return (
              ...
              >
                ...
                {item.url && (
                  <span
                    aria-hidden
                    className="absolute inset-x-0 bottom-0 h-px bg-foreground scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-500"
                  />
                )}
                <div className="flex items-start justify-between gap-3">
                  <Icon size={16} className="text-muted-foreground group-hover:text-signal transition-colors shrink-0 mt-1" />
                  {item.url && (
                    <ArrowUpRight
                      size={16}
                      className="text-muted-foreground group-hover:text-signal group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shrink-0"
                    />
                  )}
                </div>
                <div>
        ...
        <div className="mt-20 md:mt-28 grid md:grid-cols-2 gap-10 md:gap-16 items-center reveal">
          <div>
            ...
            <h3 className="text-2xl md:text-2xl font-medium leading-[1.1] tracking-tight">
          ...
          >
            ...
            <ArrowUpRight size={28} className="text-muted-foreground group-hover:text-signal group-hover:translate-x-1 group-hover:-translate-y-1 transition-all shrink-0" />
          </a>
        </div>
      </div>
    </section>
