...
export function GuestMarquee() {
  ...
  return (
 <section aria-label="Invitados destacados" className="overflow-hidden border-b border-border py-12 md:py-24">
      <div className="mask-fade-x">
        <div className="marquee marquee-slow items-center">
          {loop.map((n, i) => (
            <span key={i} className="flex items-center gap-8 whitespace-nowrap px-8">
              <span className="notranslate text-xl font-medium tracking-tight" translate="no">{n}</span>
