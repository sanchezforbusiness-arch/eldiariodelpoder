    ...
    <div className="bg-background text-foreground page-enter">
      ...
      <main className="pt-24">
        <div className="container-ddp pt-6">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-[11px] tracking-[0.28em] uppercase text-muted-foreground hover:text-gold transition-colors"
          >
          ...
          <div className="container-ddp">
            <div className="grid md:grid-cols-12 gap-10 items-center">
              <div className="md:col-span-8 reveal">
                ...
                <p className="font-serif text-3xl sm:text-4xl md:text-5xl leading-[1.05] font-light tracking-[-0.02em]">
              ...
              <div className="md:col-span-4 md:justify-self-end reveal">
                <Link
                  to="/manifiesto"
                  className="group inline-flex items-center gap-3 text-[12px] tracking-[0.24em] uppercase text-gold border-b border-gold/40 pb-2 hover:border-gold transition-colors"
                >
                  Leer el manifiesto
                  <ArrowUpRight
                    size={14}
        ...
        <section className="border-t border-border py-16 md:py-20">
          <div className="container-ddp flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <p className="font-serif text-2xl md:text-3xl font-light tracking-[-0.02em]">
